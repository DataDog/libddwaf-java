...
class BasicTests extends WafTestBase {
    ...
    void 'test running basic rule v1_0'() {
        ...
        builder.addOrUpdateRuleConfig('enya', ruleSet, ruleSetInfo)
    ...
    void 'update rule data'() {
        ...
        builder.addOrUpdateRuleConfig('enyaX', [rules_data: newData], ruleSetInfo)
        nativeWafHandle = builder.buildNativeWafHandleInstance(nativeWafHandle)
        ...
        res = Waf.runRules(['usr.id': 'paco'], limits, wafMetrics, nativeWafHandle)
        assertThat res.result, is(Waf.Result.MATCH)
        builder.removeRuleConfig('enyaX')
    }
    ...
    void 'input exclusion'() {
        ...
        ResultWithData res = Waf.runRules(['server.request.query': [excluded_key: 'true']], limits, wafMetrics,
                nativeWafHandle)
        assertThat res.result, is(Waf.Result.MATCH)
    ...
    void 'rule toggling'() {
        ...
        builder.addOrUpdateRuleConfig('enyaD', overrideSpec, ruleSetInfo)
        nativeWafHandle = builder.buildNativeWafHandleInstance(nativeWafHandle)
        ...
        builder.addOrUpdateRuleConfig('enyaX', overrideSpec, ruleSetInfo)
        nativeWafHandle = builder.buildNativeWafHandleInstance(nativeWafHandle)
        awd = Waf.runRules(
                ['server.request.headers.no_cookies': ['user-agent': 'Arachni/v1']], limits, wafMetrics,
                nativeWafHandle)
        assertThat awd.result, is(Waf.Result.OK)
        builder.removeRuleConfig('enyaX')
        builder.removeRuleConfig('enyaD')
    }
    ...
    void 'custom rules'() {
        ...
        builder.addOrUpdateRuleConfig('enya', customRules, ruleSetInfo)
        nativeWafHandle = builder.buildNativeWafHandleInstance(nativeWafHandle)
