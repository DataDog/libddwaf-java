...
class BasicTests extends WafTestBase {
    ...
    void 'test running basic rule v1_0'() {
        ...
        ResultWithData awd = Waf.runContext(
                ['server.request.headers.no_cookies': ['user-agent': 'Arachni']], limits, wafMetrics,
    ...
    void 'update rule data'() {
        ...
        ResultWithData res = Waf.runContext(['http.client_ip': '1.2.3.4'], limits, wafMetrics,
                builder.buildWafHandleInstance(null))
        ...
        res = Waf.runContext(['http.client_ip': '1.2.3.4'], limits, wafMetrics,
                builder.buildWafHandleInstance(null))
    ...
    void 'custom rules'() {
        ...
        assertThat awd.result, is(Waf.Result.OK)
        awd = Waf.runContext(
                ['server.request.headers.no_cookies': ['user-agent': 'foobar']], limits, wafMetrics,
                builder.buildWafHandleInstance(null))
        assertThat awd.result, is(Waf.Result.MATCH)
    }
}
