 ...
 * Signature: (Lcom/datadog/ddwaf/WafBuilder;Ljava/lang/String;Ljava/util/Map;[Lcom/datadog/ddwaf/WafDiagnostics;)Z
 */
JNIEXPORT jboolean JNICALL Java_com_datadog_ddwaf_WafBuilder_addOrUpdateConfigNative
  (JNIEnv *, jclass, jobject, jstring, jobject, jobjectArray);
