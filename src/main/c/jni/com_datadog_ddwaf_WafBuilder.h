 ...
 */
JNIEXPORT jboolean JNICALL Java_com_datadog_ddwaf_WafBuilder_addOrUpdateConfigNative(JNIEnv *, jclass, jobject,
                                                            jstring, jobject, jobject);

JNIEXPORT void JNICALL Java_com_datadog_ddwaf_WafBuilder_removeConfigNative(JNIEnv *, jclass, jobject, jstring);
