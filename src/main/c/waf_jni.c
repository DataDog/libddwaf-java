...
#include "jni/com_datadog_ddwaf_NativeWafHandle.h"
#include "common.h"
#include "java_call.h"
#include "json.h"
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_datadog_ddwaf_NativeWafHandle_getKnownAddresses
  (JNIEnv *env, jclass clazz, jobject handle_obj)
{
    UNUSED(clazz);
 ...
 * Signature: (Lcom/datadog/ddwaf/NativeWafHandle;)[Ljava/lang/String;
 */
JNIEXPORT jobjectArray JNICALL Java_com_datadog_ddwaf_NativeWafHandle_getKnownActions
  (JNIEnv *env, jclass clazz, jobject handle_obj)
{
    UNUSED(clazz);
...
JNIEXPORT jboolean JNICALL Java_com_datadog_ddwaf_WafBuilder_addOrUpdateRuleConfig(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL Java_com_datadog_ddwaf_NativeWafHandle_destroyNativeWafHandle(JNIEnv *env, jclass clazz, jlong waf_handle) {
    UNUSED(clazz);
