...
jobject output_convert_diagnostics_checked(JNIEnv *env, const ddwaf_object *obj)
{
    ...
    jobject rules = NULL, custom_rules = NULL, rules_data = NULL,
            rules_override = NULL, exclusions = NULL, ret = NULL, exclusion_data = NULL, actions = NULL,
    ...
    ret = java_meth_call(env, &_rsi_init, NULL, error, rulesetVersion, rules,
                         custom_rules, rules_data, rules_override, exclusions, exclusion_data, actions, processors, scanners);
...
void output_init_checked(JNIEnv *env)
{
    if (!java_meth_init_checked(env, &_rsi_init,
                                "com/datadog/ddwaf/WafDiagnostics", "<init>",
                                "(Ljava/lang/String;"
                                "Ljava/lang/String;"
    ...
    if (!java_meth_init_checked(
                ...
                "com/datadog/ddwaf/WafDiagnostics$SectionInfo", "<init>",
                                        ...
                                        const char *sect_name, size_t sect_len)
{
    ...
    ret = java_meth_call(env, &_sect_info_normal_init, NULL, skipped, loaded, failed,
                         warnings, errors);
