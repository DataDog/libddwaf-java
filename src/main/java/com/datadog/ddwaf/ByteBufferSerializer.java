...
public class ByteBufferSerializer {
    ...
    private static ByteBuffer serializeMore(ArenaLease lease, Waf.Limits limits, Map<?, ?> map, WafMetrics metrics) {
    ...
    private static void doSerialize(Arena arena, Waf.Limits limits, PWArgsBuffer pwargsSlot,
                                    String parameterName, Object value, int[] remainingElements,
                                    int depthRemaining, WafMetrics metrics) {
