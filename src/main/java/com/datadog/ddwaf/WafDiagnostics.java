...
public class WafDiagnostics {
    ...
    public static class SectionInfo {
        ...
        public SectionInfo(List<String> skipped, List<String> loaded, List<String> failed, Map<String, List<String>> warnings, Map<String, List<String>> errors) {
            this.error = null;
            this.loaded = loaded;
            this.failed = failed;
            this.errors = errors;
    ...
    public WafDiagnostics(String error, String rulesetVersion, SectionInfo rules,
                          SectionInfo customRules, SectionInfo rulesData, SectionInfo rulesOverride,
                          SectionInfo exclusions, SectionInfo exclusionData, SectionInfo actions, SectionInfo processors, SectionInfo scanners) {
        this.error = error;
    ...
    public Map<String, List<String>> getAllErrors() {
        return Stream.of(this.rules, this.customRules, this.rulesData, this.rulesOverride, this.exclusions,
                        this.exclusionData, this.actions, this.processors, this.scanners)
